  ...
  //////////////////////////////////////////////////////////////////////////////////////////////////////
	{
		...
		// (portable rewrite of the original x86 inline assembly)
		const sU64 prod = (sU64)(nexttime - time) * usecs;
		sU32 quot = (sU32)(prod / td2);
		const sU32 rem = (sU32)(prod % td2);

		const sU32 oldrem = *smplrem;
		*smplrem = oldrem + rem;
		if (*smplrem < oldrem)   // carry from the fractional part
			quot++;
		*smpldelta = quot;
	}
}
...
///////////////////////////////////////////////////////////////
{
	...
	// m_synth is a fixed-size buffer; make sure the synth state actually
	// fits into it (struct sizes differ between 32- and 64-bit builds)
	if (synthGetSize() > sizeof(m_synth)) return sFALSE;
...
//////////////////////////////////
{
	...
	destsmpl=(sU32)(((sS64)a_time*(sS64)m_samplerate)/(sS64)m_tpc);
...
//////////////////////////////////////
{
	...
	if (a_fadetime)
	{
		sU32 ftsmpls=(sU32)(((sS64)a_fadetime*(sS64)m_samplerate)/(sS64)m_tpc);
